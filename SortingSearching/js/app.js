...
var lenghtSlider = document.getElementById("length");
...
rangeSlider.oninput = function () {
  ...
  document.getElementById("searchValue").max = this.value;
};
lenghtSlider.oninput = function () {
  document.getElementById("lengthStatus").innerHTML = this.value;
  lenght = this.value;
...
speedSlider.oninput = function () {
  ...
  document.getElementById("speedStatus").innerHTML = this.value;
};
